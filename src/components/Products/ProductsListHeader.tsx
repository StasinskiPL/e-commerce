...
enum Sort{recommened,priceUp,priceDown,alphabetical}
...
const ProductsListHeader:React.FC<Props> = ({allProduct,setProducts}) => {
    ...
    useEffect(()=>{
        ...
        if(sortType === Sort.priceUp.toString()){
          setProducts(products => products.slice().sort((a,b)=> a.price - b.price))
        }
        if(sortType === Sort.priceDown.toString()){
            setProducts(products => products.slice().sort((a,b)=> b.price - a.price))
          }
    ...
    return (
        <div className="products__header">
            <div className="products__header-inner">
                ...
                <select  onChange={e=>setSortType(e.target.value)}  name="sort" id="sort">
